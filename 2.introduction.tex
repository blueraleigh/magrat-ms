...
\gb{once this is out as a preprint, Alex can cite it, and then once Alex's is out as a preprint, we can cite it upon submission, 
and thus the serpent shall eat its own tail!}. 
The tree sequence, 
while not in practice a lossless representation of the ARG \gb{it's not lossless?}, contains a wealth 
