...
pmat = persp(
    ...
    col=scales::col_numeric(LSD::colorpalette("heat", nrcol=64, rev=FALSE), range(z))(z)
    ,border=NA,box=FALSE,ticktype="detailed",expand=1.75,phi=-3,theta=75,r=2*sqrt(3),d=1,
    xlab="X", ylab="Y",zlab="Time"
)
xvec = numeric(360000 + 90000)
yvec = numeric(360000 + 90000)
o = 1
z = outer(v, v, scoreq, fn=s4)
o = 1
for (i in 1:300) {
    for (j in 1:300) {
        l = trans3d(c(vv[i],vv[i],vv[i+1],vv[i+1]), c(vv[j],vv[j+1],vv[j+1],vv[j]), .6, pmat)
        xvec[o:(o+4)] = c(l$x, NA)
        yvec[o:(o+4)] = c(l$y, NA)
        o = o + 5
    }
}
polygon(xvec, yvec,border=NA,col=scales::col_numeric(LSD::colorpalette("heat", nrcol=64, rev=FALSE), range(z))(z))
z = outer(v, v, scoreq, fn=s3[6,])
o = 1
for (i in 1:300) {
    for (j in 1:300) {
        l = trans3d(c(vv[i],vv[i],vv[i+1],vv[i+1]), c(vv[j],vv[j+1],vv[j+1],vv[j]), .8, pmat)
        xvec[o:(o+4)] = c(l$x, NA)
        yvec[o:(o+4)] = c(l$y, NA)
        o = o + 5
    }
...
for (i in 1:300) {
    for (j in 1:300) {
        l = trans3d(c(vv[i],vv[i],vv[i+1],vv[i+1]), c(vv[j],vv[j+1],vv[j+1],vv[j]), 1, pmat)
        xvec[o:(o+4)] = c(l$x, NA)
        yvec[o:(o+4)] = c(l$y, NA)
        o = o + 5
    }
...
points(trans3d(minq(s2[4,])[2], minq(s2[4,])[1], 0.15, pmat),pch=19,cex=0.8)
text(
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], 0.15, pmat)$x,
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], 0.15, pmat)$y, 3, pos=4)
points(trans3d(minq(s4)[2], minq(s4)[1], .6, pmat),pch=19,cex=0.8)
text(
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y, 4, pos=4)
points(trans3d(minq(s3[6,])[2], minq(s3[6,])[1], 0.8, pmat),pch=19,cex=0.8)
text(
    trans3d(minq(s3[6,])[2], minq(s3[6,])[1], 0.8, pmat)$x,
    trans3d(minq(s3[6,])[2], minq(s3[6,])[1], 0.8, pmat)$y, 5, pos=4)
points(trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat),pch=19,cex=0.8)
text(
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$x,
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$y, 6, pos=4)

# ARG edges

segments(
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$x,
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$y,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y
)
segments(
    trans3d(minq(s3[6,])[2], minq(s3[6,])[1], .8, pmat)$x,
    trans3d(minq(s3[6,])[2], minq(s3[6,])[1], .8, pmat)$y,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y
)
segments(
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y,
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$x,
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$y
)
segments(
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y,
    trans3d(y[2], x[2], 0, pmat)$x,
    trans3d(y[2], x[2], 0, pmat)$y
)
segments(
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$x,
    trans3d(minq(s4)[2], minq(s4)[1], .6, pmat)$y,
    trans3d(y[3], x[3], 0, pmat)$x,
    trans3d(y[3], x[3], 0, pmat)$y
)
segments(
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$x,
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$y,
...
segments(
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$x,
    trans3d(minq(s2[4,])[2], minq(s2[4,])[1], .15, pmat)$y,
    trans3d(y[1], x[1], 0, pmat)$x,
    trans3d(y[1], x[1], 0, pmat)$y
)
segments(
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$x,
    trans3d(minq(s1[7,])[2], minq(s1[7,])[1], 1, pmat)$y,
...
points(trans3d(y, x, 0, pmat),pch=22, bg="white",cex=0.8)
text(
    trans3d(y, x, 0, pmat)$x,
    trans3d(y, x, 0, pmat)$y,
    0:2, pos=1, cex=0.8
)
...
"Average minimum cost dispersal surfaces", cex=0.8,xpd=NA, adj=c(1,0))
...
text(0.5,0.95,"Minimum cost dispersal surfaces",cex=0.8,adj=c(0.5,-0.8))
...
text(1,0,"Genome position",adj=c(1,-0.2),cex=0.8)
